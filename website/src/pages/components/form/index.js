...
function FormPage() {
  const code = formatCode(`
    function renderMovieOption({ data }) {
    ...
    function movieOptionToString(option) {
        ...
        <Container padding="8">
          <Form initialValues={initialValues} onSubmit={onSubmit}>
            <Grid rowsGap="8">
              ...
              <Dropdown name="favouriteMovie" label="Favourite movie" options={movieOptions} renderOption={renderMovieOption} optionToString={movieOptionToString} />
