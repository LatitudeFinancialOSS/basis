...
export type ComponentWithProperties<Props extends {}, Properties extends {} = CommonProperties> =
  | React.ForwardRefExoticComponent<Props & React.RefAttributes<any>> & Properties
